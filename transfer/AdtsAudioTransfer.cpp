...
namespace ppbox
{
    namespace mux
    {
        ...
        static boost::uint32_t GetSamplingFrequencyIndex(boost::uint32_t sampling_frequency)
        {
        ...
        void AdtsAudioTransfer::MakeAdtsHeaderWithData(
        ...
        void AdtsAudioTransfer::MakeAdtsHeaderWithBuffer(
            boost::uint8_t bits[7], 
            boost::uint32_t frame_size,
