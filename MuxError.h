                ...
                public:
                    ...
                    std::string message(int value) const
                    {
                        switch (value) {
                            ...
                            case mux_would_block:
                                return "mux would block";
                            case mux_stream_end:
                                return "mux stream end";
                            case mux_read_sample_error:
                                return "mux read sample error";
