...
public:
    ...
    public:
        ...
        virtual AP4_Result WritePES(const unsigned char* data, 
                                    ...
                                    bool                 with_pcr, 
                                    AP4_ByteStream&      output);
        virtual AP4_Result WriteSample(ppbox::demux::Sample const &       sample, 
    ...
    AP4_Result SetVideoStream(AP4_UI32 timescale, SampleStream*& stream, ppbox::mux::AvcConfig *avc_config);
